...
(function() {
  var Slide, SlideShow, a1, addClass, byId, canTransition, ctr, disableBuilds, disableNotes, doc, li_array, linkEls, query, queryAll, removeClass, slideshow, spaces, strToArray, stylesheetPath, testStyle, toArray, toggleClass, total, transitionSlides, trim;
  doc = document;
  disableBuilds = false;
  disableNotes = false;
  ctr = 0;
  ...
  SlideShow.prototype = {
    ...
    _update: function(targetId, dontPush) {
      var currentIndex, docElem, elem, savedIndex, x;
