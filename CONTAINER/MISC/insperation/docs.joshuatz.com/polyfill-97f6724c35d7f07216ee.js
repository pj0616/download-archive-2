        ...
        ! function () {
          ...
          var ee = Array.isArray || function ( t ) {
            ...
            ie = function ( t ) {
              ...
              return function ( u, c, s, f ) {
                for ( var l, h, p = Pt( u ), v = d( p ), g = Qt( c, s, 3 ), y = ct( v.length ), m = 0, b = f || ne, S = e ? b( u, y ) : r ? b( u, 0 ) : void 0; y > m; m++ )
          ...
          if ( It( "Number", !On( " 0o1" ) || !On( "0b1" ) || On( "+0x1" ) ) ) {
            for ( var _n, jn = function ( t ) {
              ...
              }, Pn = a ? En( On ) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split( "," ), Nn = 0; Pn.length > Nn; Nn++ ) S( On, _n = Pn[ Nn ] ) && !S( jn, _n ) && Rn( jn, _n, wn( On, _n ) );
          ...
          var Ac = "undefined" != typeof globalThis && globalThis || "undefined" != typeof self && self || void 0 !== Ac && Ac,
            Ic = "URLSearchParams" in Ac,
            _c = "Symbol" in Ac && "iterator" in Symbol,
            jc = "FileReader" in Ac && "Blob" in Ac && function () {
              try {
                return new Blob, !0
              } catch ( e ) {
                return !1
          ...
          if ( Nc ) var Mc = [ "[object Int8Array]", "[object Uint8Array]", "[object Uint8ClampedArray]", "[object Int16Array]", "[object Uint16Array]", "[object Int32Array]", "[object Uint32Array]", "[object Float32Array]", "[object Float64Array]" ],
            Uc = ArrayBuffer.isView || function ( t ) {
          ...
          function Cc( t ) {
            this.map = {}, t instanceof Cc ? t.forEach( ( function ( t, e ) {
              this.append( e, t )
          ...
          function Gc() {
            return this.bodyUsed = !1, this._initBody = function ( t ) {
              ...
              return this._bodyArrayBuffer ? Fc( this ) || ( ArrayBuffer.isView( this._bodyArrayBuffer ) ? Promise.resolve( this._bodyArrayBuffer.buffer.slice( this._bodyArrayBuffer.byteOffset, this._bodyArrayBuffer.byteOffset + this._bodyArrayBuffer.byteLength ) ) : Promise.resolve( this._bodyArrayBuffer ) ) : this.blob().then( Wc )
            } ), this.text = function () {
              var t = Fc( this );
              if ( t ) return t;
          ...
          function Vc( t, e ) {
            if ( !( this instanceof Vc ) ) throw new TypeError( 'Please use the "new" operator, this DOM object constructor cannot be called as a function.' );
            var r, n, o = ( e = e || {} ).body;
            if ( t instanceof Vc ) {
              if ( t.bodyUsed ) throw new TypeError( "Already read" );
              this.url = t.url, this.credentials = t.credentials, e.headers || ( this.headers = new Cc( t.headers ) ), this.method = t.method, this.mode = t.mode, this.signal = t.signal, o || null == t._bodyInit || ( o = t._bodyInit, t.bodyUsed = !0 )
            } else this.url = String( t );
            if ( this.credentials = e.credentials || this.credentials || "same-origin", !e.headers && this.headers || ( this.headers = new Cc( e.headers ) ), this.method = ( n = ( r = e.method || this.method || "GET" ).toUpperCase(), Kc.indexOf( n ) > -1 ? n : r ), this.mode = e.mode || this.mode || null, this.signal = e.signal || this.signal, this.referrer = null, ( "GET" === this.method || "HEAD" === this.method ) && o ) throw new TypeError( "Body not allowed for GET or HEAD requests" );
          ...
          function qc( t, e ) {
            if ( !( this instanceof qc ) ) throw new TypeError( 'Please use the "new" operator, this DOM object constructor cannot be called as a function.' );
            e || ( e = {} ), this.type = "default", this.status = void 0 === e.status ? 200 : e.status, this.ok = this.status >= 200 && this.status < 300, this.statusText = "statusText" in e ? e.statusText : "", this.headers = new Cc( e.headers ), this.url = e.url || "", this._initBody( t )
          }
          Vc.prototype.clone = function () {
            return new Vc( this, {
              body: this._bodyInit
            } )
          }, Gc.call( Vc.prototype ), Gc.call( qc.prototype ), qc.prototype.clone = function () {
          ...
          try {
            ...
            ( Xc = function ( t, e ) {
              ...
              var r = Error( t );
              this.stack = r.stack
            } ).prototype = Object.create( Error.prototype ), Xc.prototype.constructor = Xc
          }
          ...
          function Yc( t, e ) {
            return new Promise( ( function ( r, n ) {
              ...
              }( o.url ), !0 ), "include" === o.credentials ? i.withCredentials = !0 : "omit" === o.credentials && ( i.withCredentials = !1 ), "responseType" in i && ( jc ? i.responseType = "blob" : Nc && o.headers.get( "Content-Type" ) && -1 !== o.headers.get( "Content-Type" ).indexOf( "application/octet-stream" ) && ( i.responseType = "arraybuffer" ) ), !e || "object" != typeof e.headers || e.headers instanceof Cc ? o.headers.forEach( ( function ( t, e ) {
          ...
          Yc.polyfill = !0, Ac.fetch || ( Ac.fetch = Yc, Ac.Headers = Cc, Ac.Request = Vc, Ac.Response = qc ),
            function ( t ) {
              var e = function () {
                  try {
...
//# sourceMappingURL=polyfill-97f6724c35d7f07216ee.js.map
